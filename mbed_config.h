...
#define MODEM_ON_BOARD_UART                                  1              // set by target:SPIIO_L151CC
...
#define MODEM_ON_BOARD                                       1              // set by target:SPIIO_L151CC
...
#define HSE_VALUE                                            8000000        // set by target:SPIIO_L151CC
#define MBED_CONF_PLATFORM_DEFAULT_SERIAL_BAUD_RATE          9600           // set by library:platform
#define MBED_CONF_APP_PASSWORD                               "spiio"        // set by application
...
#define MBED_CONF_APP_APN                                    "wlapn.com"    // set by application
...
#define MBED_CONF_APP_USERNAME                               "spiio"        // set by application
